  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black text-white tracking-tight">Payroll Command Center</h2>
          <p className="text-sm text-slate-400">At-a-glance monthly readiness, incentives, loan deductions, and 1-click execution.</p>
        </div>
      ...
      <div className="glass-panel rounded-3xl p-6 border border-indigo-500/30 bg-gradient-to-r from-indigo-950/40 via-slate-900/60 to-purple-950/40 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass-panel rounded-2xl p-5 border space-y-3 hover:border-indigo-500/40 transition-all flex flex-col justify-between">
          <div className="space-y-2">
            <div className="p-2.5 rounded-xl bg-indigo-950/60 text-indigo-400 border border-indigo-800/40 w-fit">
              <Gift className="h-5 w-5" />
            </div>
            <h4 className="text-base font-bold text-white">Quick Bonus / Incentive</h4>
        ...
        <div className="glass-panel rounded-2xl p-5 border space-y-3 hover:border-indigo-500/40 transition-all flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h4 className="text-base font-bold text-white">Salary Slips & Distribution</h4>
            <p className="text-xs text-slate-400">

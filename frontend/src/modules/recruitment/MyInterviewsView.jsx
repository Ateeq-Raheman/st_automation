...
export function MyInterviewsView({ interviews = [], onOpenFeedback, onOpenCandidate, onScheduleAdHoc, isLoading }) {
  return (
        ...
        {interviews.length === 0 ? (
          ...
          interviews.map((item) => (
            <div
              ...
              className="glass-panel rounded-2xl p-5 border border-gray-200 dark:border-slate-700 space-y-4 hover:border-brand-red/40 transition-all"
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h3 className="text-base font-bold text-brand-black dark:text-slate-50 tracking-tight">{item.applicant_name}</h3>
              ...
              <div className="bg-gray-50 dark:bg-slate-900/70 p-3 rounded-xl border border-gray-200 dark:border-slate-700 flex items-center gap-3 text-sm text-gray-700 dark:text-slate-200">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-slate-700">
                {item.resume_attachment ? (
                  ...
                  <span className="text-sm text-gray-500 dark:text-slate-400">No CV</span>
                )}
